...
export default function HomePage({ params }: { params: { id: string } }) {
  ...
  const [gID, setGID] = React.useState<any>(makeid2(6));
      ...
      {loaded ? <section className='bg-dark min-w-screen min-h-screen py-4 mx-auto text-white xl:w-[1280px]'>
        ...
        <section className='px-4 mt-4'>
          <div className='flex gap-4 mt-4 flex-col md:flex-row'>
            ...
            {userData?.id == null ? <div className='w-full flex gap-4 flex-col'>
              <div className='w-full flex flex-col px-4 sm:px-8 py-4 sm:py-6 bg-zinc-700 rounded-2xl h-fit'>
                ...
                <div className='grid grid-cols-2 mb-4'>
                  <div className='flex flex-col gap-0.5'>
                    ...
                    <div className='flex gap-2'>
                      <input className='bg-zinc-700 border-dark border rounded-2xl' value={input1} onChange={(e) => {
                  ...
                  <div className='flex flex-col gap-0.5'>
                    ...
                    <div className='flex gap-2'>
                      <input className='bg-zinc-700 border-dark border rounded-2xl' value={input2} onChange={(e) => {
                ...
                <div className='grid grid-cols-2 mb-4'>
                  <div className='flex flex-col gap-0.5'>
                    ...
                    <div className='flex gap-2'>
                      <input className='bg-zinc-700 border-dark border rounded-2xl' value={input3} onChange={(e) => {
                  ...
                  <div className='flex flex-col gap-0.5'>
                    ...
                    <div className='flex gap-2'>
                      <input className='bg-zinc-700 border-dark border rounded-2xl' value={input4} onChange={(e) => {
                ...
                <div className='grid grid-cols-2 mb-4'>
                  ...
                  <div className='flex flex-col gap-0.5'>
                    ...
                    <div className='flex gap-2'>
                      <input className='bg-zinc-700 border-dark border rounded-2xl' value={input5} onChange={(e) => {
                ...
                <div className='grid grid-cols-2 mb-4'>
                  <div className='flex flex-col gap-0.5'>
                    ...
                    <div className='flex gap-2'>
                      <input className='bg-zinc-700 border-dark border rounded-2xl' value={input6} onChange={(e) => {
                  ...
                  <div className='flex flex-col gap-0.5'>
                    ...
                    <div className='flex gap-2'>
                      <input defaultValue={"10.06.2025"} className='bg-zinc-700 border-dark border rounded-2xl' value={input7} onChange={(e) => {
            ...
            {userData?.id != null ? <div className='w-full flex gap-4 flex-col'>
              <div className='w-full flex flex-col px-4 sm:px-8 py-4 sm:py-6 bg-zinc-700 rounded-2xl h-fit'>
                <div className='flex justify-between items-center mb-4 select-none flex-col md:flex-row'>
                  <div className='text-3xl font-bold flex items-center gap-2'>Паспортные данные {userData?.status == 1 && userData?.preStatus == null ? <span className='rounded-md bg-green-500 text-base px-1 h-fit'>Активно</span> : null}{userData?.status == 1 && userData?.preStatus == 1 ? <span className='rounded-md bg-green-500 text-base px-1 h-fit bg-opacity-50 text-opacity-50'>Активно</span> : null}{userData?.status == 0 || (userData?.status == 2 && userData?.preStatus == null) ? <span className='rounded-md bg-yellow-500 text-base px-1 h-fit'>На рассмотрении</span> : null}{userData?.status == 2 && userData?.preStatus != null ? <span className='rounded-md bg-purple-500 text-base px-1 h-fit'>Приостановлено</span> : null}{userData?.status == 3 ? <span className='rounded-md bg-red-500 text-base px-1 h-fit'>Изъято</span> : null}</div>
                  <div className='flex gap-2 w-full md:w-fit justify-end md:justify-start'>
                    ...
                    {userData?.preStatus != null && userData?.preStatus == 1 ? <div className='text-sm text-zinc-500 hover:text-zinc-400 cursor-pointer w-8 h-8 bg-zinc-600 rounded-2xl flex justify-center items-center'><MdOutlinePlayCircle size={24} onClick={() => {
                      ...
                      :
                      <div onClick={() => pausePassport()} className='text-sm text-zinc-500 hover:text-zinc-400 cursor-pointer w-8 h-8 bg-zinc-600 rounded-2xl flex justify-center items-center'><MdOutlinePauseCircle size={24} /></div>}
                  </div>
                </div>
                <div className='flex justify-center w-full'>
                  <div className='mb-4 flex justify-center gap-2 bg-zinc-600 rounded-2xl w-fit p-2 items-center'>
                ...
                <div className='grid grid-cols-2 mb-4'>
                  <div className='flex flex-col gap-0.5'>
                    <div className='text-lg text-zinc-400'>Никнейм</div>
                    <div className='flex gap-2'>
                      <input placeholder={userData?.nickname} className='bg-zinc-700 border-dark border rounded-2xl' value={input1} onChange={(e) => {
                        setInput1(e.target.value)
                      }} />
                      <div className='w-10 h-10 bg-white rounded-2xl flex justify-center items-center hover:bg-gray-200 cursor-pointer' onClick={() => {
                        applyInput1();
                  ...
                  <div className='flex flex-col gap-0.5'>
                    <div className='text-lg text-zinc-400'>Псевдоним</div>
                    <div className='flex gap-2'>
                      <input placeholder={userData?.surname} className='bg-zinc-700 border-dark border rounded-2xl' value={input2} onChange={(e) => {
                        setInput2(e.target.value)
                      }} />
                      <div className='w-10 h-10 bg-white rounded-2xl flex justify-center items-center hover:bg-gray-200 cursor-pointer' onClick={() => {
                        applyInput2();
                ...
                <div className='grid grid-cols-2 mb-4'>
                  <div className='flex flex-col gap-0.5'>
                    <div className='text-lg text-zinc-400'>Дата рождения</div>
                    <div className='flex gap-2'>
                      <input placeholder={userData?.birthdate} className='bg-zinc-700 border-dark border rounded-2xl' value={input3} onChange={(e) => {
                        setInput3(e.target.value)
                      }} />
                      <div className='w-10 h-10 bg-white rounded-2xl flex justify-center items-center hover:bg-gray-200 cursor-pointer' onClick={() => {
                        applyInput3();
                  ...
                  <div className='flex flex-col gap-0.5'>
                    <div className='text-lg text-zinc-400'>Telegram</div>
                    <div className='flex gap-2'>
                      <input placeholder={userData?.tg} className='bg-zinc-700 border-dark border rounded-2xl' value={input4} onChange={(e) => {
                        setInput4(e.target.value)
                      }} />
                      <div className='w-10 h-10 bg-white rounded-2xl flex justify-center items-center hover:bg-gray-200 cursor-pointer' onClick={() => {
                        applyInput4();
                ...
                <div className='grid grid-cols-2 mb-4'>
                  ...
                  <div className='flex flex-col gap-0.5'>
                    <div className='text-lg text-zinc-400'>Выдан кем</div>
                    <div className='flex gap-2'>
                      <input placeholder={userData?.issuedby} className='bg-zinc-700 border-dark border rounded-2xl' value={input5} onChange={(e) => {
                        setInput5(e.target.value)
                      }} />
                      <div className='w-10 h-10 bg-white rounded-2xl flex justify-center items-center hover:bg-gray-200 cursor-pointer' onClick={() => {
                        applyInput5();
                ...
                <div className='grid grid-cols-2'>
                  <div className='flex flex-col gap-0.5'>
                    <div className='text-lg text-zinc-400'>Дата выдачи</div>
                    <div className='flex gap-2'>
                      <input placeholder={userData?.dateofissue} className='bg-zinc-700 border-dark border rounded-2xl' value={input6} onChange={(e) => {
                        setInput6(e.target.value)
                      }} />
                      <div className='w-10 h-10 bg-white rounded-2xl flex justify-center items-center hover:bg-gray-200 cursor-pointer' onClick={() => {
                        applyInput6();
                  ...
                  <div className='flex flex-col gap-0.5'>
                    <div className='text-lg text-zinc-400'>Действителен до</div>
                    <div className='flex gap-2'>
                      <input placeholder={userData?.validuntil} className='bg-zinc-700 border-dark border rounded-2xl' value={input7} onChange={(e) => {
                        setInput7(e.target.value)
                      }} />
                      <div className='w-10 h-10 bg-white rounded-2xl flex justify-center items-center hover:bg-gray-200 cursor-pointer' onClick={() => {
                        applyInput7();
