              ...
              <div className='flex flex-col gap-2'>
                <div className='flex gap-2 md:gap-0 md:flex-col'>
                  ...
                  <div className='flex flex-col'>
                    ...
                    <div className='font-medium text-zinc-400 text-xl'>{authData?.nickname}</div>
                    <div className='text-zinc-500'>@user{authData?.id}</div>
                  </div>
                </div>
                <div className='flex flex-wrap gap-1 select-none'>
                  {authData?.roles?.map((e: any) =>
              ...
              <div className='flex flex-col gap-2 mt-4'>
                <div className='flex flex-col'>
                  ...
                  <div className='flex gap-2'>
                    <input placeholder={authData?.surname} className='bg-zinc-700 border-dark border rounded-2xl' value={input1} onChange={(e) => {
