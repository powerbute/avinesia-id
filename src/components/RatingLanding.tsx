    ...
    <>
      {!loaded ?
        <div className='bg-dark2 shadow-inner shadow-dark3 rounded-2xl md:w-1/3 px-4 py-6 select-none'>
          ...
          <div className={'mt-2 text-lg text-start font-bold text-transparent bg-dark4 animate-pulse rounded-2xl'}>1000</div>
          <div className='flex w-full bg-dark4 animate-pulse rounded-2xl bg-opacity-20 h-2'>
          </div>
        </div>
        :
        <div className={'bg-dark2 shadow-inner shadow-dark3 rounded-2xl md:w-1/3 px-4 py-6 select-none' + (userData?.dateofissue?.substring(userData?.dateofissue?.length - 4) == "2021" ? " mt-4" : "")}>
