    ...
    <>
      {!loaded ?
        ...
        <>
          ...
          <header className='px-4 flex h-[56px] items-center justify-between'>
            <a className='hidden lg:flex items-end translation-transform hover:scale-105 text-lg gap-2' href='/'><img src='/AvinesiaFlag.png' className='w-14' /> <span className='font-bold bg-green-500 rounded-md px-[5px] py-[1px]'>ID</span><span className='font-bold bg-gradient-to-br from-rose-600 to-emerald-600 rounded-md px-[5px] py-[1px] hidden'>С днем Авинесии!</span></a>
