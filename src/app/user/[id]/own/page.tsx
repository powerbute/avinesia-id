      ...
      {loaded ? <section className='bg-dark min-w-screen min-h-screen py-4 mx-auto text-white xl:w-[1280px]'>
        ...
        <section className='px-4 mt-4'>
          ...
          <div className='flex gap-4 mt-4 flex-col md:flex-row'>
            ...
            <div className='w-full grid grid-cols-3 gap-4 rounded-2xl h-fit'>
              {ownsData?.map((e: any) =>
                <div key={makeid(5)} className='bg-zinc-700 py-6 px-8 min-h-[10rem] flex flex-col justify-between rounded-2xl'>
                  <div className={'bg-yellow-500 rounded-2xl px-2 py-1 ' + (e?.onCredit ? "block" : "hidden")}>В кредит</div>
