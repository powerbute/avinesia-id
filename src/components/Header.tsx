    ...
    <>
      ...
      <header className='px-4 flex h-[56px] items-center justify-between'>
        ...
        <div className='flex gap-4 justify-center w-full sm:w-fit sm:justify-start items-center select-none'>
          {passport.authData?.roles?.includes(1) ? <div className='bg-white hover:bg-gray-200 rounded-2xl w-10 h-10 flex justify-center items-center cursor-pointer' onClick={() => location.replace("/admin")}><MdOutlineAdminPanelSettings color='black' size={28} /></div> : null}
